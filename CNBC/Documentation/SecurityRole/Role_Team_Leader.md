...
| Privilege Name                | Entity/Area         | Access Level |
|------------------------------|---------------------|-------------|
| ...existing code... |
| (See XML for full privilege list. This role has broad permissions for managing team records, activities, contacts, notes, queues, workflows, templates, SharePoint, and user settings. Access levels use UI terms: Organization, Business Unit, User.) |
