...
# Role: Auto Allocation User

## tsk_UserStatus

| Privilege Name           | Access Level   |
|-------------------------|---------------|
| prvAppendtsk_UserStatus | User          |
| prvCreatetsk_UserStatus | User          |
| prvReadtsk_UserStatus   | User          |
| prvWritetsk_UserStatus  | User          |
...
| Privilege Name           | Access Level   |
|-------------------------|---------------|
| prvReadPluginAssembly   | Organization  |

## PluginType

| Privilege Name           | Access Level   |
|-------------------------|---------------|
| prvReadPluginType       | Organization  |

## SdkMessage

| Privilege Name           | Access Level   |
|-------------------------|---------------|
| prvReadSdkMessage       | Organization  |

## SdkMessageProcessingStep

| Privilege Name                   | Access Level   |
|----------------------------------|---------------|
| prvReadSdkMessageProcessingStep  | Organization  |

## SdkMessageProcessingStepImage

| Privilege Name                        | Access Level   |
|---------------------------------------|---------------|
| prvReadSdkMessageProcessingStepImage  | Organization  |
